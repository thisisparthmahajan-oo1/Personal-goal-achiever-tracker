...
export const GYM_PLAN: Day[] = [
  ...
  },
  {
    ...
    main: [
      ...
      {
        key: "day2-db-floor-press",
        name: "Dumbbell Floor Press",
        equipment: "Dumbbells, Mat",
        prescription: "3 × 10",
        rest: "60 s",
        form:
          "On mat, upper arms lightly touch floor at bottom. Press up controlled. Great triceps + chest builder.",
      ...
      },
      {
        ...
        rest: "60 s",
        form:
          "Body in straight line, hands under shoulders. Lower chest to floor, elbows ~45°. Drop to knees if needed.",
