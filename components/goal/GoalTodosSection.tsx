...
import { addGoalTodoAction } from "@/app/actions/goals";
import { TodoRow } from "@/components/todos/TodoRow";
import type { Todo } from "@/lib/schemas";

export function GoalTodosSection({
  goalId,
  items,
}: {
  goalId: string;
  ...
  const submit = (e?: React.FormEvent) => {
    ...
    startTransition(async () => {
      await addGoalTodoAction({ goal_id: goalId, title: t });
      setTitle("");
    });
  };
    ...
    <section className="space-y-3">
      ...
      >
        ...
        <input
          ...
          placeholder="Add a todo — it lands in /todos too"
          disabled={pending}
          maxLength={300}
