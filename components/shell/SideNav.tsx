...
import { Target, FileText, Repeat, LayoutGrid, Settings } from "lucide-react";
...
const ITEMS: Item[] = [
  ...
  { href: "/notes", label: "Notes", icon: FileText, enabled: false },
  { href: "/habits", label: "Habits", icon: Repeat, enabled: false },
